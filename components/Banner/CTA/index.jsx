    ...
    <div className="min-h-screen bg-white font-sans text-gray-900">
      ...
      <header className="sticky top-0 z-40 bg-black p-4 sm:p-6">
        <div className="container mx-auto flex justify-center items-center">
          <h1 className="text-2xl sm:text-3xl font-bold text-white">CarSourc</h1>
        </div>
      </header>
      ...
      <section id="hero" className="bg-black text-white py-16 sm:py-20 text-center">
        <div className="container mx-auto px-4">
          ...
          <p className="text-lg sm:text-xl mb-6 sm:mb-8 opacity-90 max-w-3xl mx-auto text-gray-300">
            Leveraging our network of 20+ dealer groups to find the perfect vehicle for you, without the hassle of traditional car shopping.
          </p>
          <a
            href="#client-intake"
