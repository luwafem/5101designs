  ...
  return (
    <>
      <motion.div 
        ...
        viewport={{ once: true }}
        className="animate_right grid grid-cols-2 md:grid-cols-4 lg:flex lg:flex-wrap justify-between rounded-lg lg:w-1/2"
      >
        {team.map(([item], index) => (
          <div 
            key={index} 
          ...
          >
            ...
            <div className="bg-black hover:bg-primary relative -mt-[7em] left-1/2 -translate-x-1/2 h-[90px] lg:h-[119px] grid gap-2 rounded-b-[15px] lg:rounded-b-[24px] team-profile-content">
              <div className="my-auto ml-5 grid gap-2">
                ...
                <div>
                  <p className="text-white team-details team-details-smaller">{item.description}</p>
                </div>
              </div>
            </div>
